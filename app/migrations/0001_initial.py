    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('Goa', 'Goa'), ('Assam', 'Assam'), ('Gujarat', 'Gujarat'), ('Bihar', 'Bihar'), ('Manipur', 'Manipur'), ('Kerala', 'Kerala'), ('Daman and Diu', 'Daman and Diu'), ('Kashmir', 'Kashmir')], max_length=100)),
